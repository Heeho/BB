...
import ru.ltow.bb.client.component.Animation as AnimationC
import com.badlogic.gdx.utils.Array
import com.badlogic.gdx.utils.ArrayMap
import com.badlogic.gdx.graphics.g2d.Animation
import ru.ltow.bb.client.component.Billboard
import ru.ltow.bb.common.component.*
import ru.ltow.bb.common.system.FaceSystem
...
class AnimationSystem (
  ...
  override fun updateInterval() {
    creatures.forEach { e ->
      ...
      val a = ru.ltow.bb.client.component.Animation(packs[c.name])
      val f = Face()
